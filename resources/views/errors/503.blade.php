    ...
    <div class="row justify-content-center">
        <div class="col-lg-4">
            <div class="text-center">
                ...
                <h4 class="text-uppercase text-danger mt-3">{{ __('Service Unavailable') }}</h4>
                <p class="text-muted mt-3">{{ __('The system is in maintenance mode, please try again later.') }}</p>
