...
beforeEach(function () {
    ...
    $this->component = Livewire::test(ModificationDatatable::class);
});
...
it('will show modifications', function () {
...
it('can delete modification', function (){
    $modification = Modification::factory()->create();

    $this->component
        ->call('delete', $modification->id)
        ...
        ->assertDispatched('flashNotification', message: 'Modification request declined');
