...
return [
    ...
    'components' => [
        ...
        'form-flatpickr' => [
            'view'  => 'form-components::{framework}.form-flatpickr',
            'class' => \App\View\Components\FormFlatpickr::class,
        ],

        'form-select2' => [
            'view'  => 'form-components::{framework}.form-select2',
            'class' => \App\View\Components\FormSelect2::class,
        ],
    ],
];
